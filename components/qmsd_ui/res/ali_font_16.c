 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font /root/hmi_esp32/hmi/aliph.ttf -r 0x20-0x7F --symbols 寸仪表南坪快速℃× --size 16 --format lvgl --bpp 4 --no-compress -o ali_font_16.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x1f, 0x11, 0xff, 0xff, 0xff, 0xff, 0xa0,
    0x0, 0x1f, 0x10, 0x33, 0x37, 0xe3, 0x33, 0x20,
    0x0, 0x1f, 0x10, 0x93, 0x4, 0xe0, 0x8, 0x40,
    0xe, 0xff, 0xfc, 0x7c, 0x4, 0xe0, 0x1f, 0x20,
    0x3, 0x4f, 0x43, 0xe, 0x54, 0xe0, 0x8a, 0x0,
    0x0, 0x1f, 0x10, 0x7, 0x94, 0xe0, 0xe2, 0x0,
    0x0, 0x1f, 0x10, 0x0, 0x4, 0xe0, 0x0, 0x0,
    0x0, 0x1f, 0x16, 0xee, 0xee, 0xfe, 0xee, 0xe5,
    0x0, 0x1f, 0x11, 0x44, 0x47, 0xe4, 0x44, 0x41,
    0x0, 0x1f, 0x8d, 0x0, 0x4, 0xe0, 0x0, 0x0,
    0x2a, 0xef, 0xd8, 0x0, 0x4, 0xe0, 0x0, 0x0,
    0x2b, 0x72, 0x0, 0x0, 0x4, 0xe0, 0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3864, .adv_w = 141, .box_w = 9, .box_h = 8, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 3900, .adv_w = 235, .box_w = 14, .box_h = 13, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 3991, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4119, .adv_w = 252, .box_w = 15, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4239, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4359, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4472, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4600, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -2},
